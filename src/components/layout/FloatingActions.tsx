...
import { WHATSAPP_ENQUIRY_URL } from '@/lib/constants'
      ...
      <AnimatePresence>
        {showTop && (
          <motion.button
            ...
            className="flex h-11 w-11 items-center justify-center rounded-full border border-gray-200 bg-white text-primary shadow-card transition-colors hover:bg-primary hover:text-white"
          >
