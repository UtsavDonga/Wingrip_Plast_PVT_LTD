...
export default function ShareButtons({ slug, title }: { slug: string; title: string }) {
  ...
  const btn =
    'flex h-10 w-10 items-center justify-center rounded-full border border-gray-200 text-gray-500 transition-all hover:border-primary hover:bg-primary hover:text-white'

  return (
    <div className="flex items-center gap-2">
      <span className="mr-1 text-xs font-semibold uppercase tracking-wide text-gray-400">Share</span>
      <a
